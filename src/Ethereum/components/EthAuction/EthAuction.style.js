...
const EthAuctionWrapper = styled.div`
  .EthAuction_section {
    min-height: calc(100vh - 131px - 160px);

    .EthAuction_section_title {
      display: flex;
    ...
    .EthAuction_section_overview_section {
...
export default EthAuctionWrapper;
