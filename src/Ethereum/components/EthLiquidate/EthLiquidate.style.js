...
const EthLiquidateWrapper = styled.div`
  .EthLiquidate {
            ...
            tr {
              ...
              td {
                ...
                .EthLiquidate_btn {
                  ...
                  & .EthLiquidate_btn_tooltip::after {
                    content: "";
                    position: absolute;
                    top: 100%;
                    left: 50%;
                  ...
                  &:hover .EthLiquidate_btn_tooltip {
                    visibility: visible;
                    opacity: 1;
                    transform: scale(1);
                    z-index: 1000;
...
export default EthLiquidateWrapper;
