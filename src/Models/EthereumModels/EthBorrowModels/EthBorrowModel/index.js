...
import { EthBorrowTokens } from "../../../../assets/api/Ethereum/EthBorrowApi";
import { EthBorrowTokenSelect } from "../../../../redux/actions/EthereumActions/EthBorrowActions";
import ModelSWrapper from "../../../Model.style";

const EthBorrowModel = ({ ethBorrowModel, setEthBorrowModel }) => {
  const dispatch = useDispatch();

  const EthBorrowModelFilterFunction = () => {
  ...
  const removeOverLay = (val) => {
    dispatch(EthBorrowTokenSelect(val));
                  ...
                  <div className="col-lg-4 col-2 d-flex justify-content-end">
                    <div className="close_div">
                      <RiCloseCircleLine
                        ...
                        onClick={() => setEthBorrowModel(false)}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-12">
                    <div className="search_box">
                      <input
                        ...
                        onKeyUp={() => EthBorrowModelFilterFunction()}
                      />
                    </div>
                  </div>
