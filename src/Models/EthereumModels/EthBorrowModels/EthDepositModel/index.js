...
import { EthDepositTokens } from "../../../../assets/api/Ethereum/EthBorrowApi";
import { EthDepositTokenSelect } from "../../../../redux/actions/EthereumActions/EthBorrowActions";
import ModelSWrapper from "../../../Model.style";

const EthDepositModel = ({ ethDepositModel, setEthDepositModel }) => {
  const dispatch = useDispatch();

  const EthDepositModelFilterFunction = () => {
  ...
  const removeOverLay = (val) => {
    dispatch(EthDepositTokenSelect(val));
                  ...
                  <div className="col-lg-4 col-2 d-flex justify-content-end">
                    <div className="close_div">
                      <RiCloseCircleLine
                        ...
                        onClick={() => setEthDepositModel(false)}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-12">
                    <div className="search_box">
                      <input
                        ...
                        onKeyUp={() => EthDepositModelFilterFunction()}
                      />
                    </div>
                  </div>
...
export default EthDepositModel;
