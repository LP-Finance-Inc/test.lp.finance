...
import { EthRepayTokens } from "../../../../assets/api/Ethereum/EthBorrowApi";
import { EthRepayTokenSelect } from "../../../../redux/actions/EthereumActions/EthBorrowActions";
import ModelSWrapper from "../../../Model.style";

const EthRepayModel = ({ ethRepayModel, setEthRepayModel }) => {
  const dispatch = useDispatch();

  const EthRepayModelFilterFunction = () => {
  ...
  const removeOverLay = (val) => {
    dispatch(EthRepayTokenSelect(val));
                  ...
                  <div className="col-lg-4 col-2 d-flex justify-content-end">
                    <div className="close_div">
                      <RiCloseCircleLine
                        ...
                        onClick={() => setEthRepayModel(false)}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-12">
                    <div className="search_box">
                      <input
                        ...
                        onKeyUp={() => EthRepayModelFilterFunction()}
                      />
                    </div>
                  </div>
