...
import { TopEthSwapTokens } from "../../../../assets/api/Ethereum/EthSwapApi";
import { TopEthSwapTokenSelect } from "../../../../redux/actions/EthereumActions/EthSwapActions";
import ModelSWrapper from "../../../Model.style";

const TopEthSwapModel = ({ topEthSwapModel, setTopEthSwapModel }) => {
  const dispatch = useDispatch();

  const FilterEthSwapModel = () => {
  ...
  const removeOverLay = (val) => {
    dispatch(TopEthSwapTokenSelect(val));
    var overlay = document.getElementById("overlay");
    var popup = document.getElementById("popup");
    popup.classList.remove("show");
    overlay.classList.remove("show");
    setTimeout(() => {
      setTopEthSwapModel(false);
    }, 500);
  };
                  ...
                  <div className="col-lg-4 col-2 d-flex justify-content-end">
                    <div className="close_div">
                      <RiCloseCircleLine
                        ...
                        onClick={() => setTopEthSwapModel(false)}
                      />
                    </div>
                  </div>
                </div>
...
export default TopEthSwapModel;
