...
const WithdrawModel = ({ withdrawModel, setWithdrawModel }) => {
  const dispatch = useDispatch();
  const WithdrawTokenApiNew = WithdrawTokenApi();

  const WithdrawModelFilterFunction = () => {
                  ...
                  <div className="col-lg-4 col-2 d-flex justify-content-end">
                    <div className="close_div">
                      <RiCloseCircleLine
                        ...
                        onClick={() => setWithdrawModel(false)}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-12">
                    <div className="search_box">
                      <input
                        ...
                        onKeyUp={() => WithdrawModelFilterFunction()}
                      />
                    </div>
                  </div>
