...
const BottomSwapModel = ({ bottomSwapModel, setBottomSwapModel }) => {
  const dispatch = useDispatch();

  const BottomSwapTokenApiNew = BottomSwapTokenApi();

  const SwapModelFilterFunction = () => {
  ...
  const removeOverLay = (img, name) => {
    dispatch(BottomSwapTokenSelect(img, name));
                  ...
                  <div className="col-lg-4 col-2 d-flex justify-content-end">
                    <div className="close_div">
                      <RiCloseCircleLine
                        ...
                        onClick={() => setBottomSwapModel(false)}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-12">
                    <div className="search_box">
                      <input
                        ...
                        onKeyUp={() => SwapModelFilterFunction()}
                      />
                    </div>
                  </div>
...
export default BottomSwapModel;
