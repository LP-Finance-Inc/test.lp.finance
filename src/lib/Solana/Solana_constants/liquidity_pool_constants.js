...
export const liquidityPoolStableSwap_name = "swap-pool-pda";
...
export const LPFi_Pool = new PublicKey(
  "GnFDvH41YPW3DtQcaHEk4xZhG3Xeh9XXgwsC2EWHkoSb"
);

export const USDC_Pool = new PublicKey(
  "26UWs5QHCgNPeLBpQvjQpZ9TmonKLJFmx21SHXBZ7w9V"
);
